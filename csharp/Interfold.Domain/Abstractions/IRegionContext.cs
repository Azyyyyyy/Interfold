...
/// string concern owned by <see cref="ScopedSystemId"/> and
/// <see cref="SystemIdNormalization"/>. Only a <see cref="SystemId"/> overload is
/// exposed; production ingress (JWT middleware, route binding) constructs the wrapper at
/// the trust boundary so no caller has a bare string in hand here.
/// </summary>
