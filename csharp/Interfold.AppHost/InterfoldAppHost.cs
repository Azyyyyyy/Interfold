...
public static class InterfoldAppHost
{
    ...
    public static void Configure(IDistributedApplicationBuilder builder)
    {
        ...
        var includeApi = !string.Equals(builder.Configuration[AppHostParameterKeys.IncludeApi], "false", StringComparison.OrdinalIgnoreCase);
        var persistentContainers = !string.Equals(builder.Configuration[AppHostParameterKeys.PersistentContainers], "false", StringComparison.OrdinalIgnoreCase);
        ...
        var includeScylla = ParseToggle(builder.Configuration[AppHostParameterKeys.IncludeScylla], fallback: true);
        var includeCassandra = ParseToggle(builder.Configuration[AppHostParameterKeys.IncludeCassandra], fallback: false);
        var scyllaTopology = builder.Configuration[AppHostParameterKeys.ScyllaTopology] ?? "single";
        ...
        var includePostgres = ParseToggle(builder.Configuration[AppHostParameterKeys.IncludePostgres], fallback: true);
        ...
        var includeDashboard = !string.Equals(builder.Configuration[AppHostParameterKeys.IncludeDashboard], "false", StringComparison.OrdinalIgnoreCase);
        ...
        if (includeApi)
        {
            ...
            {
                api.WithEnvironment(OctoconEnvKeys.Persistence, "scylla-postgres")
        ...
        var includeWeb = !string.Equals(builder.Configuration[AppHostParameterKeys.IncludeWeb], "false", StringComparison.OrdinalIgnoreCase);
        ...
        var webTls = ParseToggle(builder.Configuration[AppHostParameterKeys.WebTls], fallback: false);
        if (includeWeb)
        {
